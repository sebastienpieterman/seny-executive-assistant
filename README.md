...
Self-hosted and designed with the principle that your AI assistant should work *for* you, not *as* you. Your database, files, and integrations live on your own infrastructure. Conversations are sent to Anthropic's Claude API for AI processing — review Anthropic's data policies to understand how they handle API data.
